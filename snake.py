...
# velocidad de nuestra serpiente
speed = 15
...
# enumerar los errores
if(check_errors[1] > 0):
    print("Error " + check_errors[1])
else:
    print("Game succesfully initialized")

# iniciar el juego en windows
pygame.display.set_caption("Snake Game UNI")
...
while True:
    ...
    pygame.draw.rect(game_window, red, pygame.Rect(
        food_pos[0], food_pos[1] + 2, square_size, square_size))
